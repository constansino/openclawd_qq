...
export const QQConfigSchema = z.object({
  ...
  showProcessingStatus: BooleanInputSchema(true).describe("长任务状态提示开关。开启后，机器人处理过久会自动提示“仍在处理中”。"),
  processingStatusDelayMs: NumberInputSchema(12000).describe("首次显示“处理中”提示的延迟（毫秒）。建议 8000~15000。"),
  processingStatusIntervalMs: NumberInputSchema(30000).describe("处理超时后的周期心跳间隔（毫秒）。建议 20000~60000。"),
  processingStatusText: z.preprocess((value) => normalizeLooseString(value), z.string().optional().default("⏳任务还在后台处理中，我还活着，别急哈～")).describe("长任务首次提示文案。"),
  processingPulseText: z.preprocess((value) => normalizeLooseString(value), z.string().optional().default("⏳还在处理（已运行 {elapsed}s）...")).describe("长任务周期心跳文案，支持 {elapsed} 占位符。"),
