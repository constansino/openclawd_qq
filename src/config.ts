...
export const QQConfigSchema = z.object({
  ...
  requireMention: BooleanInputSchema(true).describe("群聊是否需要 @ 机器人才触发。建议开启以节省 Token。"),
  ...
  keywordTriggers: KeywordTriggersSchema.describe("关键词触发（字符串）。Web表单填：小助手, 帮我；Raw JSON 填：\"小助手, 帮我\"。"),
